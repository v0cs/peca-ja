...
/**
 * Teste da API Veicular Corrigida (v2)
 * Usando a estrutura correta da API consultarplaca.com.br
 */

async function testarApiV2Corrigida() {
  console.log("🚗 Testando API Veicular corrigida (v2)...\n");
  ...
  // Teste com placa de teste gratuita
  console.log("2️⃣ Teste com placa de teste gratuita (AAA0000):");
  try {
  ...
  console.log("🎉 Testes da API v2 corrigida concluídos!");
  console.log("\n📋 Resumo da integração corrigida:");
  console.log("✅ API v2 configurada corretamente");
  console.log("✅ Endpoint correto: /consultarPlaca?placa={placa}");
  console.log("✅ Autenticação Basic Auth com email:api_key");
  console.log("✅ Estrutura de resposta da API v2 processada");
  ...
  console.log("- Base URL: https://api.consultarplaca.com.br/v2");
  console.log("- Endpoint: /consultarPlaca?placa={placa}");
  console.log("- Autenticação: Basic Auth (email:api_key)");
  console.log("- Cache TTL: 24 horas");
  console.log("- Rate Limit: 100 consultas/15min (prod), 500/15min (dev)");
  console.log("- Placa de teste: AAA0000 (gratuita)");
}

// Executar os testes
testarApiV2Corrigida().catch(console.error);
