...
describe("rateLimitMiddleware - apiRateLimiter keyGenerator com IP", () => {
  let apiKeyGenerator;
  ...
  it("deve executar keyGenerator do apiRateLimiter sem usuário autenticado (linha 146)", () => {
    ...
    expect(key).toBe("api:192.168.1.10");
  });
});
